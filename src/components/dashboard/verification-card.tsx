...
function VerificationCard({
  ...
  return (
    <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-blue-900/20 via-black to-black border border-blue-500/20 p-5 transition-all duration-300 hover:border-blue-500/40 group">
      {/* Background decorative elements */}
      <div className="absolute -top-12 -right-12 opacity-10 group-hover:opacity-20 transition-opacity duration-500">
        <ScanFace className="w-48 h-48 text-blue-500 rotate-12" strokeWidth={1} />
      </div>
      ...
      <div className="relative z-10">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 className="text-base font-bold text-white tracking-tight">Verify Humanity</h3>
            <div className="flex items-center gap-2 mt-0.5">
              <span className="w-1.5 h-1.5 rounded-full bg-blue-500 animate-pulse" />
              <span className="text-[10px] font-medium text-blue-400 uppercase tracking-wider">Required</span>
            </div>
          </div>
        </div>
