  ...
  return (
    <div className='space-y-6'>
          ...
          {metadata.verification.is_verified ? (
            ...
            <div className='flex items-center gap-3 p-3 bg-orange-500/5 border border-orange-500/20 rounded-lg'>
              ...
              <span className='text-sm text-orange-200'>
                Verification failed. Human confidence score is below the
                threshold.
              </span>
            </div>
          )}
      ...
      <button
        ...
        className='w-full py-3 border border-white/10 hover:bg-white/5 rounded-xl text-sm font-medium text-gray-400 hover:text-white transition-colors flex items-center justify-center gap-2 cursor-pointer'
      >
